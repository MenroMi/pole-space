  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="relative hidden flex-col items-start justify-end overflow-hidden bg-surface-lowest p-20 pb-24 lg:flex lg:w-3/5 xl:w-2/3">
        ...
        <div className="absolute -top-40 -left-40 h-[600px] w-[600px] rounded-full bg-primary-container/20 blur-3xl" />
        <div className="absolute top-1/3 left-1/4 h-[400px] w-[400px] rounded-full bg-primary/10 blur-3xl" />
